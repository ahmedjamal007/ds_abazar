-- =====================================================================
--  دوائي (Dawaii) — essential seed (SQLite): default settings.
--  Idempotent (INSERT OR IGNORE) — runs on every startup, so it must only
--  contain rows the app cannot live without. Demo/sample data lives in
--  seed.demo.sql and is applied ONCE by DatabaseInitializer, so anything
--  the user deletes stays deleted.
-- =====================================================================
