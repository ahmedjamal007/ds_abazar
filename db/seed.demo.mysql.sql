-- =====================================================================
-- MySQL demo data (network mode): ~20 sample medicines with Arabic names,
-- starter stock batches, and two sample customers.
...
INSERT IGNORE INTO stock_batches (item_id,quantity_units,expiry_date,batch_number,strips_per_box,units_per_strip,box_purchase_price,box_selling_price) VALUES
...
INSERT IGNORE INTO customers (id,name,phone,balance) VALUES
